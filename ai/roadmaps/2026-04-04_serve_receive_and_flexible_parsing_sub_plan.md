...
| # | Task |
|---|------|
| 1 | Add `serve_receive` to schema, types, stats aggregation, and UI/report vocabulary |
| 2 | Expand deterministic parser aliases and relation patterns for serve receive + more natural set/kill phrasing |
| 3 | Broaden clause splitting for longer spoken rally sentences without making parsing opaque |
| 4 | Verify mixed multi-event behavior still works with clause-level AI fallback rules unchanged |
| 5 | Add evidence notes and update roadmap/changelog when implementation is complete |
